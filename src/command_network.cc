...
initialize_command_network() {
  ...
  CMD2_ANY_VOID    ("reload_ip_filter", std::bind(&core::Manager::reload_ip_filter, control->core()));
  CMD2_ANY_LIST    ("ip_filter",        std::bind(&apply_ip_filter, std::placeholders::_2));

  CMD2_ANY         ("done_fg_color",       std::bind(&ui::Root::get_done_fg_color, control->ui()));
  CMD2_ANY_VALUE_V ("done_fg_color.set",   std::bind(&ui::Root::set_done_fg_color, control->ui(), std::placeholders::_2));
  CMD2_ANY         ("done_bg_color",       std::bind(&ui::Root::get_done_bg_color, control->ui()));
  CMD2_ANY_VALUE_V ("done_bg_color.set",   std::bind(&ui::Root::set_done_bg_color, control->ui(), std::placeholders::_2));
  CMD2_ANY         ("active_fg_color",     std::bind(&ui::Root::get_active_fg_color, control->ui()));
  CMD2_ANY_VALUE_V ("active_fg_color.set", std::bind(&ui::Root::set_active_fg_color, control->ui(), std::placeholders::_2));
  CMD2_ANY         ("active_bg_color",     std::bind(&ui::Root::get_active_bg_color, control->ui()));
  CMD2_ANY_VALUE_V ("active_bg_color.set", std::bind(&ui::Root::set_active_bg_color, control->ui(), std::placeholders::_2));
}
